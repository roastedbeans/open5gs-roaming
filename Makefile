...
.PHONY: base-open5gs amf ausf bsf nrf nssf pcf scp sepp smf udm udr upf webui networkui all clean
...
networkui:
	docker build --build-arg NODE_VERSION=${NODE_VERSION} --build-arg OPEN5GS_VERSION=${OPEN5GS_VERSION} -t networkui:${OPEN5GS_VERSION} ./images/networkui

all: base-open5gs amf ausf bsf nrf nssf pcf scp sepp smf udm udr upf webui networkui
...
clean:
	...
	webui:${OPEN5GS_VERSION} networkui:${OPEN5GS_VERSION}
