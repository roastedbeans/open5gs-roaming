# CICFlowMeter for Open5GS Roaming AI Detection

> **Enhanced CICFlowMeter** - Integrated with AI-based network intrusion detection for Open5GS roaming environments.

This fork of CICFlowMeter has been customized with:
- **AI Model Selection**: Choose specific ML models (CNN, LSTM, Autoencoder, etc.)
- **Real-time Detection**: Stream flows directly to AI detection API
- **Attack Logging**: Comprehensive logging of detected threats
- **76 Feature Extraction**: Optimized for AI model compatibility
