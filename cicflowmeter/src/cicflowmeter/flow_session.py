...
class FlowSession(DefaultSession):
    ...
    def __init__(
        self, output_mode=None, output=None, fields=None, model_type="ensemble", verbose=False, *args, **kwargs
    ):
        ...
        self.output_writer = output_writer_factory(self.output_mode, self.output, model_type=self.model_type)
