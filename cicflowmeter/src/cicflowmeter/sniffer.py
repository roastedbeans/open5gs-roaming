...
def create_sniffer(
    input_file, input_interface, output_mode, output, fields=None, model_type="ensemble", verbose=False
):
...
def main():
    ...
    parser.add_argument(
        ...
        dest="model_type",
        default="ensemble",
        choices=["cnn", "mlp", "rnn", "lstm", "gru", "autoencoder", "ensemble"],
        help="AI model to use for detection (default: ensemble)",
    )
